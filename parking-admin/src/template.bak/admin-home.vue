...
<script>
	export default {
		...
		methods: {
			dropLine() {
				var admin_flowDistribution = this.$echarts.init(document.getElementById('admin_flowDistribution'));
				...
				var subsidiary = this.$echarts.init(document.getElementById('subsidiary'));
